---
name: beads
description: Use bd (beads) as the task tracker for projects that use it. Use when creating, updating, finding, or closing tasks/issues, or when tempted to create TODO lists in markdown.
---
