...
# ~/.config/*
							...
							xdg.configFile."lsd".source  = dotfiles + "/config/lsd";  # FIX: Added lsd config symlink
							...
							# macOS-specific configs  
								...
								xdg.configFile."aerospace".source = dotfiles + "/aerospace";  # Optional: Add aerospace config if you have one
			...
			modules = [
				...
				home-manager.darwinModules.home-manager
				{
					...
					home-manager.users.kamil = { pkgs, config, ... }: {
						...
						xdg.configFile."wezterm".source = dotfiles + "/wezterm";
						xdg.configFile."lazygit".source = dotfiles + "/config/lazygit";
						xdg.configFile."lazydocker".source = dotfiles + "/config/lazydocker";  # FIX: Added lazydocker config for macOS
						xdg.configFile."lsd".source = dotfiles + "/config/lsd";  # FIX: Added lsd config symlink for macOS
