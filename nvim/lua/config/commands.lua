...
-- Load the opt-in Neovim experiments scratchpad on demand.
vim.api.nvim_create_user_command('Experiments', function()
  require('config.experiments').setup()
  vim.notify('Neovim experiments loaded')
end, { desc = 'Load optional Neovim experiments' })
