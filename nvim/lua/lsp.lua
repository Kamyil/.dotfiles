-- require('lsp/server_configs/')
-- TODO: Get all the files from ./server_configs directory and apply the config via `vim.lsp.config['filename'] = config`
--
-- Enable LSP servers
vim.lsp.enable({
  -- 'gopls',
...
-- Extras (via adibhanna, thank you!)
